...
flowchart TB
    ...
    API -.| --anonymous-auth=false<br/>--audit-policy<br/>--encryption-provider-config| API
    Etcd -.| TLS client + peer<br/>file perms 0600<br/>encryption at rest| Etcd
    Kubelet -.| --read-only-port=0<br/>--anonymous-auth=false<br/>--authorization-mode=Webhook| Kubelet
    Runtime -.| seccomp default<br/>AppArmor / SELinux| Runtime
```
